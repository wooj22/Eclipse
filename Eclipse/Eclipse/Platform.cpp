...
Platform::Platform()
{
	...
	platform_long1_grass = SceneManager::Get().GetCurrentScene()->CreateObject<Platform_Long_Grass>({ -800.0f, -650.0f });
	...
	platform_short1_grass = SceneManager::Get().GetCurrentScene()->CreateObject<Platform_Short_Grass>({ -150.0f, -500.0f });

	platform_middle2_grass = SceneManager::Get().GetCurrentScene()->CreateObject<Platform_Middle_Grass>({ 850.0f, -500.0f });

	platform_wall1_grass = SceneManager::Get().GetCurrentScene()->CreateObject<Platform_Wall_Grass>({ 1050.0f, -280.0f });

	platform_middle3_grass = SceneManager::Get().GetCurrentScene()->CreateObject<Platform_Middle_Grass>({ -600.0f, -320.0f });
	cemetery2 = SceneManager::Get().GetCurrentScene()->CreateObject<Cemetery>({ -750.0f, -220.0f });

	platform_middle4_grass = SceneManager::Get().GetCurrentScene()->CreateObject<Platform_Middle_Grass>({ 250.0f, -320.0f });
	...
	platform_long2_grass = SceneManager::Get().GetCurrentScene()->CreateObject<Platform_Long_Grass>({ 950.0f, 120.0f });
